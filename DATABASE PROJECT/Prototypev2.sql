...
/*------------------------------------------------------------------------*/
/*View creation for Admin starts here */
DELIMITER $$ 
create view Customer_Credentials as select Cust_UserId,Pwd from Customer ;
$$
DELIMITER $$ 
...
DELIMITER $$ 
create view Driver_Credentials as select Driv_UserId,Pwd from Driver ;
$$
DELIMITER $$ 
...
/*View creation for Admin ends here */